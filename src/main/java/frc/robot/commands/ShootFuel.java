...
public class ShootFuel extends Command {
    ...
    public ShootFuel(ShooterSubsystem launcher, double speed){
    ...
    public void execute(){
        ...
        if(timer.hasElapsed(1)){
            ...
            System.out.println("TopShooter is running at: " + launcher.getTopShooterRPM());
            System.out.println("BottomShooter is running at " + launcher.getBottomShooterRPM());
            ...
            System.out.println("Top Current RPM: " + launcher.getTopShooterRPM());
            System.out.println("Bottom Current RPM " + launcher.getBottomShooterRPM());
        }
    }
